...
function createCorsResponse(data) {
  ...
  // Add CORS headers manually (though Google Apps Script should handle this automatically)
  // These headers will be ignored in deployed web apps, but good to have for clarity
  return output;
}
