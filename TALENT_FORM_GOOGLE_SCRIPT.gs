/**
 * Google Apps Script for Talent Applications (Existing Spreadsheet)
...
function doPost(e) {
  try {
    ...
    // ⚠️ REPLACE THIS WITH YOUR ACTUAL SPREADSHEET ID ⚠️
    const SPREADSHEET_ID = 'PASTE_YOUR_SPREADSHEET_ID_HERE';
    
    // Instructions to get your spreadsheet ID:
    // 1. Open your existing spreadsheet in Google Sheets
    // 2. Copy the ID from the URL: https://docs.google.com/spreadsheets/d/SPREADSHEET_ID/edit
    // 3. Replace 'PASTE_YOUR_SPREADSHEET_ID_HERE' above with your actual ID
    ...
    try {
      ...
      const resumeFileName = data.resume?.name || 'Resume uploaded';
...
function testWithSampleData() {
  const sampleData = {
    ...
    bio: "Experienced full-stack developer with 6 years of experience building scalable web applications.",
